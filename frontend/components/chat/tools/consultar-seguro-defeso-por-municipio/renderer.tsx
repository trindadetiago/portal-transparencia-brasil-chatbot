...
import type { ConsultarSeguroDefesoPorMunicipioInput, ConsultarSeguroDefesoPorMunicipioOutput, BeneficioPorMunicipioDTO } from "./types";

export function renderConsultarSeguroDefesoPorMunicipioInput(input: ConsultarSeguroDefesoPorMunicipioInput) {
  return (
...
export function renderConsultarSeguroDefesoPorMunicipioOutput(output: ConsultarSeguroDefesoPorMunicipioOutput | string) {
