...
import type { ConsultarContratosPorNumeroInput, ConsultarContratosPorNumeroOutput, ContratoDTO } from "./types";

export function renderConsultarContratosPorNumeroInput(input: ConsultarContratosPorNumeroInput) {
  return <InfoField label="Consulta" value={JSON.stringify(input)} />;
}

export function renderConsultarContratosPorNumeroOutput(output: ConsultarContratosPorNumeroOutput | string) {
