...
import type { ConsultarBpcPorMunicipioInput, ConsultarBpcPorMunicipioOutput, BeneficioPorMunicipioDTO } from "./types";

export function renderConsultarBpcPorMunicipioInput(input: ConsultarBpcPorMunicipioInput) {
  return <InfoField label="Consulta" value={JSON.stringify(input)} />;
}

export function renderConsultarBpcPorMunicipioOutput(output: ConsultarBpcPorMunicipioOutput | string) {
