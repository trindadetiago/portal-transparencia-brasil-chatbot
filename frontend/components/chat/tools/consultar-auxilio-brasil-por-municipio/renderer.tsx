...
import type { ConsultarAuxilioBrasilPorMunicipioInput, ConsultarAuxilioBrasilPorMunicipioOutput, BeneficioPorMunicipioDTO } from "./types";
import { Heart } from "lucide-react";

export function renderConsultarAuxilioBrasilPorMunicipioInput(input: ConsultarAuxilioBrasilPorMunicipioInput) {
  return (
...
export function renderConsultarAuxilioBrasilPorMunicipioOutput(output: ConsultarAuxilioBrasilPorMunicipioOutput | string) {
